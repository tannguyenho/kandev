...
owners:
  - cfl
---
# Parent-Child Task Stop Requirements
...
### REQ-TASKS-PARENT-CHILD-TASK-STOP-001: Parent-Child Task Stop

**Intent:** Preserve the observable task or workflow behavior recorded by the legacy specification.

#### Acceptance criteria

- **AC-TASKS-PARENT-CHILD-TASK-STOP-001.1:** When a consumer uses this capability, the system shall provide the observable behavior and exclusions documented below.
