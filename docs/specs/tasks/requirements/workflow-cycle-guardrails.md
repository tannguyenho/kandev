...
owners:
  - kandev
---
# Workflow Cycle Guardrails Requirements
...
### REQ-TASKS-WORKFLOW-CYCLE-GUARDRAILS-001: Workflow Cycle Guardrails

**Intent:** Preserve the observable task or workflow behavior recorded by the legacy specification.

#### Acceptance criteria

- **AC-TASKS-WORKFLOW-CYCLE-GUARDRAILS-001.1:** When a consumer uses this capability, the system shall provide the observable behavior and exclusions documented below.
