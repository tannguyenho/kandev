...
- **AC-PLATFORM-STARTUP-LIFECYCLE-001.4:** Startup shall report phase transitions and elapsed time, with bounded periodic status during long phases. A completion percentage shall be reported only for a step whose total was measured, as defined by [startup progress visibility](startup-progress-visibility.md) (AC-PLATFORM-STARTUP-PROGRESS-001.6 and AC-PLATFORM-STARTUP-PROGRESS-001.7).
