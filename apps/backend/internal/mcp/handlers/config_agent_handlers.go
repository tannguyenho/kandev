...
func (h *Handlers) publishAgentProfileEvent(ctx context.Context, eventType string, profile *agentsettingsdto.AgentProfileDTO) {
	...
	// needed by sessionless pickers, mirroring the HTTP settings publisher.
