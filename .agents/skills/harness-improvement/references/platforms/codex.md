...
Kandev maintains only the read-only `.codex/agents/pr-poller.toml`, using
GPT-5.6 Luna at medium reasoning effort for an explicitly user-authorized PR
wait. Other project-local agents require the user's explicit request and cost
approval.
